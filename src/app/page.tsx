    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-bold text-foreground">BorrowHub</h1>
            </div>

            <div className="flex items-center space-x-4">
              {user ? (
                <>
                  <Button onClick={handlePostItem} className="bg-emerald-600 hover:bg-emerald-700">
      ...
      <section className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-foreground mb-4 text-balance">Borrow, Share, Connect</h2>
          <p className="text-xl text-muted-foreground mb-8 text-pretty max-w-2xl mx-auto">
            Discover items from your community. Lend what you don't use, borrow what you need.
          </p>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-2xl font-bold text-foreground">Available Items</h3>
              ...
              >
                ...
                <CardContent className="p-4">
                  <div className="flex items-start justify-between mb-2">
                    <CardTitle className="text-lg font-semibold text-foreground line-clamp-1">{item.title}</CardTitle>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <Avatar className="w-6 h-6">
                        <AvatarFallback className="text-xs">{item.owner.charAt(0)}</AvatarFallback>
                      </Avatar>
      ...
      {/* Post Item Modal */}
      <PostItemModal isOpen={showPostModal} onClose={() => setShowPostModal(false)} />
    </div>
  )
}
